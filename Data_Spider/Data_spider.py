...
def getPageList(year, month, day):
    ...
    参数：年，月，日
    '''
    url = 'http://paper.people.com.cn/gjjrb/html/' + year + '-' + month + '/' + day + '/node_647.htm'
    html = fetchUrl(url)
    ...
    for page in pageList:
        link = page.a["href"]
        url = 'http://paper.people.com.cn/gjjrb/html/' + year + '-' + month + '/' + day + '/' + link
        linkList.append(url)
        #print(url)
...
def download_rmrb(year, month, day, destdir):
    ...
    for page in pageList:
        ...
        for url in titleList:
            ...
            if title.find("广告")+1 or title.find("图片")+1:
                break
